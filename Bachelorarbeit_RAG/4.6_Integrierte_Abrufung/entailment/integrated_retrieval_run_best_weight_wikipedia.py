...
filename = "Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/wikipedia/result_hybrid_wiki_ibm_scores.pkl"
df = pd.read_pickle(filename)

with open('Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/wikipedia/classification_archive/results_wikipedia_k10_entailment.json', 'r') as file:
    entailment_data = json.load(file)

def get_entailment_result(entailment_data, question, hash_id): # Directly accessing the saved classification results from previous iterations
...
weight = 1.29 # Set the best weight
...
with open('Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/wikipedia/classification_archive/best_weight_results.json', 'w', encoding='utf-8') as f:
    f.write(json_output)

print(df)
df.to_pickle('Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/wikipedia/integrated_retrieval_result_wikipedia_best_weight.pkl')
df.to_csv('Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/wikipedia/integrated_retrieval_result_wikipedia_best_weight.csv', index=False)
