...
weight = 1.48 # Set the best weight
...
with open('Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/pubmed/classification_archive/best_weight_results.json', 'w', encoding='utf-8') as f:
    f.write(json_output)

print(df)
df.to_pickle('Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/pubmed/integrated_retrieval_result_pubmed_best_weight.pkl')
df.to_csv('Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/pubmed/integrated_retrieval_result_pubmed_best_weight.csv', index=False)
