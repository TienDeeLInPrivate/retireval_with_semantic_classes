...
filename_wikipedia = "Bachelorarbeit_RAG/4.5_Re-Ranking_Semantische_Klassen/entailment/data/wikipedia/reranked_result_hybrid_10.pkl"
filename_wikipedia_integrated = "Bachelorarbeit_RAG/4.6_Integrierte_Abrufung/entailment/data/wikipedia/integrated_retrieval_result_wikipedia_best_weight.pkl"
...
# Uncomment this to automatically copy dataframe to clipboard, can be pastet into Excel etc...
...
fig = px.line(top_k_df, x='Top K', y=top_k_df.columns[1:], markers=True,
              ...
              title="Vergleich der Top-K Genauigkeit: Integrierte Abrufung (QNLI) vs Re-Ranking vs Original")
fig.update_layout(
    ...
    title=dict(text="Vergleich der Top-K Genauigkeit: Integrierte Abrufung (QNLI) vs Re-Ranking vs Original", x=0.5, xanchor='center', font=dict(size=29)),
